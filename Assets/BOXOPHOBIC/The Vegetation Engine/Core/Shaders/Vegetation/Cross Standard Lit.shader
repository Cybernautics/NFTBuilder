	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 VertexPos40_g51437 = temp_output_2283_0_g50724;
				...
				float WorldData19_g51438 = ( Bounds_Height374_g50724 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g51438 = WorldData19_g51438;
				#else
				float staticSwitch14_g51438 = ObjectData20_g51438;
				#endif
				float Motion_Max_Bending1133_g50724 = staticSwitch14_g51438;
				...
				half4 Global_Motion_Params3909_g50724 = lerpResult87_g51481;
				float4 break322_g51421 = Global_Motion_Params3909_g50724;
				half Wind_Power369_g51421 = break322_g51421.z;
				float lerpResult376_g51421 = lerp( 0.1 , 1.0 , Wind_Power369_g51421);
				half Wind_Power_103106_g50724 = lerpResult376_g51421;
				...
				half2 Wind_DirectionOS39_g50724 = (temp_output_339_0_g51421).xz;
				...
				half Wind_Power2223_g50724 = Wind_Power369_g51421;
				float temp_output_167_0_g51439 = Wind_Power2223_g50724;
				...
				half Global_NoiseTex_R34_g50724 = break142_g51439.r;
				...
				#endif
				half Motion_Variation3073_g50724 = staticSwitch14_g51496;
				half Motion_Variation284_g51477 = ( _MotionVariation_10 * Motion_Variation3073_g50724 );
				...
				half Input_Turbulence327_g51477 = Global_NoiseTex_R34_g50724;
				float2 lerpResult321_g51477 = lerp( Sine_MinusOneToOne281_g51477 , temp_cast_12 , Input_Turbulence327_g51477);
				half2 Motion_Bending2258_g50724 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g50724 ) * Wind_Power_103106_g50724 * Wind_DirectionOS39_g50724 * Global_NoiseTex_R34_g50724 * lerpResult321_g51477 );
				...
				half4 Global_React_Params4173_g50724 = lerpResult87_g51524;
				float4 break322_g51522 = Global_React_Params4173_g50724;
				half Interaction_Mask66_g50724 = break322_g51522.z;
				...
				half2 Interaction_DirectionOS4158_g50724 = (temp_output_339_0_g51522).xz;
				...
				half Angle44_g51437 = Motion_Z190_g50724;
				...
				half Angle44_g51436 = -Motion_X216_g50724;
				float3 Vertex_Motion_Object833_g50724 = ( VertexPosRotationAxis50_g51436 + ( VertexPosOtherAxis82_g51436 * cos( Angle44_g51436 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g51436 ) * sin( Angle44_g51436 ) ) );
				...
				#endif
				half Global_Vertex_Size174_g50724 = break322_g51522.w;
				...
				half3 ObjectData20_g51435 = appendResult3480_g50724;
				...
				#endif
				half3 Vertex_Size1741_g50724 = staticSwitch14_g51435;
				...
				float4 lerpResult2779_g50724 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g51549 ) / ( _GradientMaxValue - temp_output_7_0_g51549 ) ) ));
				half3 Gradient_Tint2784_g50724 = (lerpResult2779_g50724).rgb;
				float3 vertexToFrag11_g51559 = Gradient_Tint2784_g50724;
				...
				half Noise_Mask3162_g50724 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_20 * PositionWS_PerVertex3905_g50724 * 0.1 ), 0.0 ).r - temp_output_7_0_g51560 ) / ( _NoiseMaxValue - temp_output_7_0_g51560 ) ) );
				...
				float3 vertexToFrag11_g51553 = Noise_Tint2802_g50724;
				...
				float3 Position58_g51502 = PositionWS_PerVertex3905_g50724;
				...
				half Global_ColorsTex_A1701_g50724 = (lerpResult88_g51502).a;
				float vertexToFrag11_g51555 = Global_ColorsTex_A1701_g50724;
						...
						)
			{
				...
				half2 Main_UVs15_g50724 = vertexToFrag11_g51423;
				...
				half3 Blend_AlbedoTinted2808_g50724 = ( vertexToFrag11_g51559 * vertexToFrag11_g51553 * float3(1,1,1) * Blend_Albedo265_g50724 );
				...
				half Global_Colors_Influence3668_g50724 = vertexToFrag11_g51555;
				...
				half3 Global_ColorsTex_RGB1700_g50724 = (lerpResult88_g51502).rgb;
				...
				half Global_Colors_Mask3692_g50724 = saturate( ( ( Main_Mask57_g50724 - temp_output_7_0_g51543 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g51543 ) ) );
				...
				half Subsurface_Mask1557_g50724 = saturate( ( ( Main_Mask57_g50724 - temp_output_7_0_g51556 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g51556 ) ) );
				...
				half3 Subsurface_Deferred1693_g50724 = ( Subsurface_Transmission884_g50724 * Mask_Subsurface_View782_g50724 * Blend_AlbedoColored863_g50724 );
				half3 Blend_AlbedoAndSubsurface149_g50724 = ( Blend_AlbedoColored863_g50724 + Subsurface_Deferred1693_g50724 );
				half3 Global_OverlayColor1758_g50724 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g50724 = tex2DNode29_g50724.g;
				float3 Position82_g51514 = PositionWS_PerVertex3905_g50724;
				...
				half Global_Extras_Overlay156_g50724 = break89_g51514.b;
				...
				half Overlay_Mask269_g50724 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g50724 ) * Overlay_Commons1365_g50724 ) - temp_output_7_0_g51561 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g51561 ) ) );
				...
				half2 Emissive_UVs2468_g50724 = vertexToFrag11_g51537;
				half3 Final_Emissive2476_g50724 = ( (( hdEmission4189_g50724 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g50724 ) )).rgb * TVE_EmissiveValue );
				...
				half Global_Extras_Wetness305_g50724 = break89_g51514.g;
				...
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g50724;
				...
				float temp_output_661_0_g50724 = ( saturate( ( temp_output_41_0_g51554 + ( temp_output_41_0_g51554 * SAMPLE_TEXTURE3D( TVE_ScreenTex3D, samplerTVE_ScreenTex3D, ( TVE_ScreenTexCoord * PositionWS_PerVertex3905_g50724 ) ).r ) ) ) * Final_Alpha3754_g50724 );
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-2176,-896;Half;False;Property;_IsCrossShader;_IsCrossShader;211;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;287;-2176,-384;Inherit;False;Base Shader;0;;50724;856f7164d1c579d43a5cf4968a75ca43;79,3880,1,3882,1,3957,1,4029,1,4028,1,3903,1,3904,1,3900,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,1271,0,3889,1,1708,1,3658,1,3509,1,1712,2,3873,0,1714,1,1715,1,1718,1,1717,1,916,0,1762,0,1763,0,3568,0,1949,1,1776,0,3475,1,893,0,1745,1,3479,0,3501,1,3221,2,1646,1,1690,1,1757,0,2807,1,3886,0,2953,1,3887,0,3243,0,3888,0,3728,0,3949,0,2172,0,3883,1,2658,0,1742,0,3484,0,3575,0,1733,0,1734,0,1736,0,1737,0,1735,0,1550,0,878,0,4070,0,4069,0,4067,0,4068,0,4072,0,860,1,3544,1,2261,1,2260,1,2032,0,2054,0,2060,0,2036,0,2062,0,2039,0,4177,1,3592,1,2750,0;0;19;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
Node;AmplifyShaderEditor.RangedFloatNode;129;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;210;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;274;-2176,384;Inherit;False;Define TVE IS VEGETATION SHADER;-1;;51562;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;320;-1856,384;Inherit;False;Define PIPELINE HD;-1;;51563;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=11108A74FBF0F3C4B4D19B9D6AE8F42FDF052FA9