	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 PositionOS3588_g51348 = inputMesh.positionOS;
				half3 _Vector1 = half3(0,0,0);
				half3 Off19_g51539 = _Vector1;
				float3 appendResult2827_g51348 = (float3(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord3.w , inputMesh.ase_texcoord.w));
				half3 Mesh_PivotsData2831_g51348 = ( appendResult2827_g51348 * _VertexPivotMode );
				half3 On20_g51539 = Mesh_PivotsData2831_g51348;
				#ifdef TVE_PIVOT_DATA_BAKED
				float3 staticSwitch14_g51539 = On20_g51539;
				#else
				float3 staticSwitch14_g51539 = Off19_g51539;
				#endif
				half3 ObjectData20_g51540 = staticSwitch14_g51539;
				half3 WorldData19_g51540 = Off19_g51539;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g51540 = WorldData19_g51540;
				#else
				float3 staticSwitch14_g51540 = ObjectData20_g51540;
				#endif
				half3 Mesh_PivotsOS2291_g51348 = staticSwitch14_g51540;
				float3 temp_output_2283_0_g51348 = ( PositionOS3588_g51348 - Mesh_PivotsOS2291_g51348 );
				half3 VertexPos40_g51437 = temp_output_2283_0_g51348;
				...
				float Bounds_Height374_g51348 = _MaxBoundsInfo.y;
				float WorldData19_g51438 = ( Bounds_Height374_g51348 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g51438 = WorldData19_g51438;
				#else
				float staticSwitch14_g51438 = ObjectData20_g51438;
				#endif
				float Motion_Max_Bending1133_g51348 = staticSwitch14_g51438;
				...
				half4 Global_Motion_Params3909_g51348 = lerpResult87_g51481;
				float4 break322_g51421 = Global_Motion_Params3909_g51348;
				half Wind_Power369_g51421 = break322_g51421.z;
				float lerpResult376_g51421 = lerp( 0.1 , 1.0 , Wind_Power369_g51421);
				half Wind_Power_103106_g51348 = lerpResult376_g51421;
				...
				half2 Wind_DirectionOS39_g51348 = (temp_output_339_0_g51421).xz;
				...
				half Wind_Power2223_g51348 = Wind_Power369_g51421;
				float temp_output_167_0_g51439 = Wind_Power2223_g51348;
				float lerpResult168_g51439 = lerp( 1.5 , 0.25 , temp_output_167_0_g51439);
				float4 temp_cast_9 = (lerpResult168_g51439).xxxx;
				float4 break142_g51439 = pow( saferPower77_g51439 , temp_cast_9 );
				half Global_NoiseTex_R34_g51348 = break142_g51439.r;
				...
				#endif
				half Motion_Variation3073_g51348 = staticSwitch14_g51496;
				half Motion_Variation284_g51477 = ( _MotionVariation_10 * Motion_Variation3073_g51348 );
				...
				half Input_Turbulence327_g51477 = Global_NoiseTex_R34_g51348;
				float2 lerpResult321_g51477 = lerp( Sine_MinusOneToOne281_g51477 , temp_cast_12 , Input_Turbulence327_g51477);
				half2 Motion_Bending2258_g51348 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g51348 ) * Wind_Power_103106_g51348 * Wind_DirectionOS39_g51348 * Global_NoiseTex_R34_g51348 * lerpResult321_g51477 );
				half Interaction_Amplitude4137_g51348 = _InteractionAmplitude;
				...
				half4 Global_React_Params4173_g51348 = lerpResult87_g51524;
				float4 break322_g51522 = Global_React_Params4173_g51348;
				half Interaction_Mask66_g51348 = break322_g51522.z;
				...
				half2 Interaction_DirectionOS4158_g51348 = (temp_output_339_0_g51522).xz;
				float lerpResult3307_g51348 = lerp( 1.0 , Motion_Variation3073_g51348 , _InteractionVariation);
				half2 Motion_Interaction53_g51348 = ( Interaction_Amplitude4137_g51348 * Motion_Max_Bending1133_g51348 * Interaction_Mask66_g51348 * Interaction_Mask66_g51348 * Interaction_DirectionOS4158_g51348 * lerpResult3307_g51348 );
				float2 lerpResult109_g51348 = lerp( Motion_Bending2258_g51348 , Motion_Interaction53_g51348 , ( Interaction_Mask66_g51348 * saturate( Interaction_Amplitude4137_g51348 ) ));
				half Mesh_Motion_182_g51348 = inputMesh.ase_texcoord3.x;
				float2 break143_g51348 = ( lerpResult109_g51348 * Mesh_Motion_182_g51348 );
				half Motion_Z190_g51348 = break143_g51348.y;
				half Angle44_g51437 = Motion_Z190_g51348;
				...
				half Motion_X216_g51348 = break143_g51348.x;
				half Angle44_g51436 = -Motion_X216_g51348;
				half Motion_Scale321_g51550 = ( _MotionScale_32 * 10.0 );
				half Input_Speed62_g51550 = _MotionSpeed_32;
				float mulTime349_g51550 = _TimeParameters.x * Input_Speed62_g51550;
				float Motion_Variation330_g51550 = ( _MotionVariation_32 * Motion_Variation3073_g51348 );
				float Bounds_Radius121_g51348 = _MaxBoundsInfo.x;
				half Input_Amplitude58_g51550 = ( _MotionAmplitude_32 * Bounds_Radius121_g51348 * 0.1 );
				float temp_output_299_0_g51550 = ( sin( ( ( ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) * Motion_Scale321_g51550 ) + mulTime349_g51550 + Motion_Variation330_g51550 ) ) * Input_Amplitude58_g51550 );
				float3 appendResult354_g51550 = (float3(temp_output_299_0_g51550 , 0.0 , temp_output_299_0_g51550));
				#ifdef TVE_IS_GRASS_SHADER
				float3 staticSwitch358_g51550 = appendResult354_g51550;
				#else
				float3 staticSwitch358_g51550 = ( temp_output_299_0_g51550 * inputMesh.normalOS );
				#endif
				half Global_NoiseTex_A139_g51348 = break142_g51439.a;
				half Mesh_Motion_3144_g51348 = inputMesh.ase_texcoord3.z;
				float lerpResult378_g51421 = lerp( 0.3 , 1.0 , Wind_Power369_g51421);
				half Wind_Power_323115_g51348 = lerpResult378_g51421;
				float temp_output_7_0_g51448 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g51348 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g51448 ) / ( TVE_MotionFadeStart - temp_output_7_0_g51448 ) ) );
				half3 Motion_Detail263_g51348 = ( staticSwitch358_g51550 * ( ( Global_NoiseTex_R34_g51348 + Global_NoiseTex_A139_g51348 ) * Mesh_Motion_3144_g51348 * Wind_Power_323115_g51348 ) * Wind_FadeOut4005_g51348 );
				float3 Vertex_Motion_Object833_g51348 = ( ( VertexPosRotationAxis50_g51436 + ( VertexPosOtherAxis82_g51436 * cos( Angle44_g51436 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g51436 ) * sin( Angle44_g51436 ) ) ) + Motion_Detail263_g51348 );
				float3 temp_output_3474_0_g51348 = ( PositionOS3588_g51348 - Mesh_PivotsOS2291_g51348 );
				float3 appendResult2043_g51348 = (float3(Motion_X216_g51348 , 0.0 , Motion_Z190_g51348));
				float3 Vertex_Motion_World1118_g51348 = ( ( temp_output_3474_0_g51348 + appendResult2043_g51348 ) + Motion_Detail263_g51348 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g51348 = Vertex_Motion_World1118_g51348;
				#else
				float3 staticSwitch3312_g51348 = ( Vertex_Motion_Object833_g51348 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g51348 = break322_g51522.w;
				float lerpResult346_g51348 = lerp( 1.0 , Global_Vertex_Size174_g51348 , _GlobalSize);
				float3 appendResult3480_g51348 = (float3(lerpResult346_g51348 , lerpResult346_g51348 , lerpResult346_g51348));
				half3 ObjectData20_g51435 = appendResult3480_g51348;
				...
				#endif
				half3 Vertex_Size1741_g51348 = staticSwitch14_g51435;
				half3 _Vector5 = half3(1,1,1);
				float3 localObjectPosition_UNITY_MATRIX_M14_g51531 = ObjectPosition_UNITY_MATRIX_M();
				half3 Off19_g51532 = localObjectPosition_UNITY_MATRIX_M14_g51531;
				float3 appendResult93_g51531 = (float3(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord3.w , inputMesh.ase_texcoord.w));
				float3 temp_output_91_0_g51531 = ( appendResult93_g51531 * _vertex_pivot_mode );
				float3 PivotsOnly105_g51531 = (mul( GetObjectToWorldMatrix(), float4( temp_output_91_0_g51531 , 0.0 ) ).xyz).xyz;
				half3 On20_g51532 = ( localObjectPosition_UNITY_MATRIX_M14_g51531 + PivotsOnly105_g51531 );
				#ifdef TVE_PIVOT_DATA_BAKED
				float3 staticSwitch14_g51532 = On20_g51532;
				#else
				float3 staticSwitch14_g51532 = Off19_g51532;
				#endif
				half3 ObjectData20_g51533 = staticSwitch14_g51532;
				half3 WorldData19_g51533 = Off19_g51532;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g51533 = WorldData19_g51533;
				#else
				float3 staticSwitch14_g51533 = ObjectData20_g51533;
				#endif
				float3 temp_output_66_0_g51531 = staticSwitch14_g51533;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g51531 = ( temp_output_66_0_g51531 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g51531 = temp_output_66_0_g51531;
				#endif
				float temp_output_7_0_g51476 = _SizeFadeEndValue;
				float temp_output_335_0_g51348 = saturate( ( ( ( distance( _WorldSpaceCameraPos , staticSwitch13_g51531 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g51476 ) / ( _SizeFadeStartValue - temp_output_7_0_g51476 ) ) );
				float3 appendResult3482_g51348 = (float3(temp_output_335_0_g51348 , temp_output_335_0_g51348 , temp_output_335_0_g51348));
				float3 lerpResult3556_g51348 = lerp( _Vector5 , appendResult3482_g51348 , _SizeFadeMode);
				half3 ObjectData20_g51538 = lerpResult3556_g51348;
				half3 WorldData19_g51538 = _Vector5;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g51538 = WorldData19_g51538;
				#else
				float3 staticSwitch14_g51538 = ObjectData20_g51538;
				#endif
				float3 Vertex_SizeFade1740_g51348 = staticSwitch14_g51538;
				float3 normalizeResult2696_g51348 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 break2709_g51348 = cross( normalizeResult2696_g51348 , half3(0,1,0) );
				float3 appendResult2710_g51348 = (float3(-break2709_g51348.z , 0.0 , break2709_g51348.x));
				float3 appendResult2667_g51348 = (float3(inputMesh.ase_color.r , 0.5 , inputMesh.ase_color.r));
				float3 normalizeResult2169_g51348 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 ViewDir_Normalized3963_g51348 = normalizeResult2169_g51348;
				float dotResult2212_g51348 = dot( ViewDir_Normalized3963_g51348 , float3(0,1,0) );
				half Mask_HView2656_g51348 = dotResult2212_g51348;
				float saferPower2652_g51348 = max( Mask_HView2656_g51348 , 0.0001 );
				half3 Grass_Coverage2661_g51348 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g51348 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g51348*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * inputMesh.ase_color.a * pow( saferPower2652_g51348 , _PerspectiveAngleValue ) );
				float3 Final_VertexPosition890_g51348 = ( ( staticSwitch3312_g51348 * Vertex_Size1741_g51348 * Vertex_SizeFade1740_g51348 ) + Mesh_PivotsOS2291_g51348 + Grass_Coverage2661_g51348 );
				
				float temp_output_7_0_g51549 = _GradientMinValue;
				float4 lerpResult2779_g51348 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g51549 ) / ( _GradientMaxValue - temp_output_7_0_g51549 ) ) ));
				half3 Gradient_Tint2784_g51348 = (lerpResult2779_g51348).rgb;
				float3 vertexToFrag11_g51559 = Gradient_Tint2784_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag11_g51559;
				float3 temp_cast_24 = (_NoiseScaleValue).xxx;
				float3 vertexToFrag3890_g51348 = ase_worldPos;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
				float temp_output_7_0_g51560 = _NoiseMinValue;
				half Noise_Mask3162_g51348 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_24 * PositionWS_PerVertex3905_g51348 * 0.1 ), 0.0 ).r - temp_output_7_0_g51560 ) / ( _NoiseMaxValue - temp_output_7_0_g51560 ) ) );
				float4 lerpResult2800_g51348 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g51348);
				half3 Noise_Tint2802_g51348 = (lerpResult2800_g51348).rgb;
				float3 vertexToFrag11_g51553 = Noise_Tint2802_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag11_g51553;
				float lerpResult169_g51439 = lerp( 4.0 , 2.0 , temp_output_167_0_g51439);
				half Global_NoiseTex_H2869_g51348 = pow( abs( tex2DNode75_g51439.a ) , lerpResult169_g51439 );
				half3 Highlight_Tint3231_g51348 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g51348 * Wind_Power_103106_g51348 * inputMesh.ase_color.r ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g51547 = Highlight_Tint3231_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag11_g51547;
				float2 vertexToFrag11_g51423 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag11_g51423;
				float3 Position58_g51502 = PositionWS_PerVertex3905_g51348;
				float temp_output_82_0_g51502 = _LayerColorsValue;
				float4 lerpResult88_g51502 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g51502).xz ) ),temp_output_82_0_g51502, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g51502]);
				half Global_ColorsTex_A1701_g51348 = (lerpResult88_g51502).a;
				float vertexToFrag11_g51555 = Global_ColorsTex_A1701_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g51555;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g51348;
				
				float2 vertexToFrag11_g51537 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.zw = vertexToFrag11_g51537;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g51348;
						...
						)
			{
				...
				float3 vertexToFrag11_g51559 = packedInput.ase_texcoord5.xyz;
				float3 vertexToFrag11_g51553 = packedInput.ase_texcoord6.xyz;
				float3 vertexToFrag11_g51547 = packedInput.ase_texcoord7.xyz;
				float2 vertexToFrag11_g51423 = packedInput.ase_texcoord8.xy;
				half2 Main_UVs15_g51348 = vertexToFrag11_g51423;
				float4 tex2DNode29_g51348 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51348 );
				float3 temp_output_51_0_g51348 = ( (_MainColor).rgb * (tex2DNode29_g51348).rgb );
				half3 Main_Albedo99_g51348 = temp_output_51_0_g51348;
				half3 Blend_Albedo265_g51348 = Main_Albedo99_g51348;
				half3 Blend_AlbedoTinted2808_g51348 = ( vertexToFrag11_g51559 * vertexToFrag11_g51553 * vertexToFrag11_g51547 * Blend_Albedo265_g51348 );
				float dotResult3616_g51348 = dot( Blend_AlbedoTinted2808_g51348 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g51348).xxx;
				float vertexToFrag11_g51555 = packedInput.ase_texcoord5.w;
				half Global_Colors_Influence3668_g51348 = vertexToFrag11_g51555;
				float3 lerpResult3618_g51348 = lerp( Blend_AlbedoTinted2808_g51348 , temp_cast_0 , Global_Colors_Influence3668_g51348);
				float3 vertexToFrag3890_g51348 = packedInput.ase_texcoord9.xyz;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
				float3 Position58_g51502 = PositionWS_PerVertex3905_g51348;
				float temp_output_82_0_g51502 = _LayerColorsValue;
				float4 lerpResult88_g51502 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g51502).xz ) ),temp_output_82_0_g51502 ) , TVE_ColorsUsage[(int)temp_output_82_0_g51502]);
				half3 Global_ColorsTex_RGB1700_g51348 = (lerpResult88_g51502).rgb;
				float3 temp_output_1953_0_g51348 = ( Global_ColorsTex_RGB1700_g51348 * 4.594794 );
				half3 Global_Colors1954_g51348 = temp_output_1953_0_g51348;
				float lerpResult3870_g51348 = lerp( 1.0 , packedInput.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g51348 = ( _GlobalColors * lerpResult3870_g51348 );
				float temp_output_7_0_g51543 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g51348 = saturate( ( ( ( 1.0 - packedInput.ase_color.a ) - temp_output_7_0_g51543 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g51543 ) ) );
				float3 lerpResult3628_g51348 = lerp( Blend_AlbedoTinted2808_g51348 , ( lerpResult3618_g51348 * Global_Colors1954_g51348 ) , ( Global_Colors_Value3650_g51348 * Global_Colors_Mask3692_g51348 ));
				half3 Blend_AlbedoColored863_g51348 = lerpResult3628_g51348;
				float3 temp_output_799_0_g51348 = (_SubsurfaceColor).rgb;
				float dotResult3930_g51348 = dot( temp_output_799_0_g51348 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g51348).xxx;
				float3 lerpResult3932_g51348 = lerp( temp_output_799_0_g51348 , temp_cast_3 , Global_Colors_Influence3668_g51348);
				float3 lerpResult3942_g51348 = lerp( temp_output_799_0_g51348 , ( lerpResult3932_g51348 * Global_Colors1954_g51348 ) , ( Global_Colors_Value3650_g51348 * Global_Colors_Mask3692_g51348 ));
				half3 Subsurface_Color1722_g51348 = lerpResult3942_g51348;
				half MainLight_Subsurface4041_g51348 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g51348 = ( _SubsurfaceValue * MainLight_Subsurface4041_g51348 );
				float temp_output_7_0_g51556 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g51348 = saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g51556 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g51556 ) ) );
				half3 Subsurface_Transmission884_g51348 = ( Subsurface_Color1722_g51348 * Subsurface_Intensity1752_g51348 * Subsurface_Mask1557_g51348 );
				half3 MainLight_Direction3926_g51348 = TVE_MainLightDirection;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 normalizeResult2169_g51348 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 ViewDir_Normalized3963_g51348 = normalizeResult2169_g51348;
				float dotResult785_g51348 = dot( -MainLight_Direction3926_g51348 , ViewDir_Normalized3963_g51348 );
				float saferPower1624_g51348 = max( (dotResult785_g51348*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g51348 = 0.0;
				#else
				float staticSwitch1602_g51348 = ( pow( saferPower1624_g51348 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g51348 = staticSwitch1602_g51348;
				half3 Subsurface_Deferred1693_g51348 = ( Subsurface_Transmission884_g51348 * Mask_Subsurface_View782_g51348 * Blend_AlbedoColored863_g51348 );
				half3 Blend_AlbedoAndSubsurface149_g51348 = ( Blend_AlbedoColored863_g51348 + Subsurface_Deferred1693_g51348 );
				half3 Global_OverlayColor1758_g51348 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g51348 = tex2DNode29_g51348.g;
				float3 Position82_g51514 = PositionWS_PerVertex3905_g51348;
				...
				half Global_Extras_Overlay156_g51348 = break89_g51514.b;
				float temp_output_1025_0_g51348 = ( _GlobalOverlay * Global_Extras_Overlay156_g51348 );
				float lerpResult1065_g51348 = lerp( 1.0 , packedInput.ase_color.r , _OverlayVariationValue);
				half Overlay_Commons1365_g51348 = ( temp_output_1025_0_g51348 * lerpResult1065_g51348 );
				float temp_output_7_0_g51561 = _OverlayMaskMinValue;
				half Overlay_Mask269_g51348 = saturate( ( ( ( ( ( packedInput.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g51348 ) * Overlay_Commons1365_g51348 ) - temp_output_7_0_g51561 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g51561 ) ) );
				float3 lerpResult336_g51348 = lerp( Blend_AlbedoAndSubsurface149_g51348 , Global_OverlayColor1758_g51348 , Overlay_Mask269_g51348);
				half3 Final_Albedo359_g51348 = lerpResult336_g51348;
				float3 temp_cast_6 = (1.0).xxx;
				float Mesh_Occlusion318_g51348 = packedInput.ase_color.g;
				float temp_output_7_0_g51557 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g51348 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , saturate( ( ( Mesh_Occlusion318_g51348 - temp_output_7_0_g51557 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g51557 ) ) ));
				float3 Vertex_Occlusion648_g51348 = lerpResult2945_g51348;
				
				float3 unpack4112_g51348 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g51348 ), _MainNormalValue );
				unpack4112_g51348.z = lerp( 1, unpack4112_g51348.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51348 = unpack4112_g51348;
				float3 temp_output_13_0_g51558 = Main_Normal137_g51348;
				float3 switchResult12_g51558 = (((isFrontFace>0)?(temp_output_13_0_g51558):(( temp_output_13_0_g51558 * _render_normals_options ))));
				half3 Blend_Normal312_g51348 = switchResult12_g51558;
				half3 Final_Normal366_g51348 = Blend_Normal312_g51348;
				
				float3 temp_cast_8 = (( 0.04 * _RenderSpecular )).xxx;
				
				float3 hdEmission4189_g51348 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g51537 = packedInput.ase_texcoord8.zw;
				half2 Emissive_UVs2468_g51348 = vertexToFrag11_g51537;
				half3 Final_Emissive2476_g51348 = ( (( hdEmission4189_g51348 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51348 ) )).rgb * TVE_EmissiveValue );
				
				float4 tex2DNode35_g51348 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g51348 );
				half Main_Smoothness227_g51348 = ( tex2DNode35_g51348.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g51348 = Main_Smoothness227_g51348;
				half Global_OverlaySmoothness311_g51348 = TVE_OverlaySmoothness;
				float lerpResult343_g51348 = lerp( Blend_Smoothness314_g51348 , Global_OverlaySmoothness311_g51348 , Overlay_Mask269_g51348);
				half Final_Smoothness371_g51348 = lerpResult343_g51348;
				half Global_Extras_Wetness305_g51348 = break89_g51514.g;
				float lerpResult3673_g51348 = lerp( 0.0 , Global_Extras_Wetness305_g51348 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g51348 = saturate( ( Final_Smoothness371_g51348 + lerpResult3673_g51348 ) );
				
				float lerpResult240_g51348 = lerp( 1.0 , tex2DNode35_g51348.g , _MainOcclusionValue);
				half Main_Occlusion247_g51348 = lerpResult240_g51348;
				half Blend_Occlusion323_g51348 = Main_Occlusion247_g51348;
				
				float localCustomAlphaClip3735_g51348 = ( 0.0 );
				half Final_AlphaFade3727_g51348 = 1.0;
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g51348;
				float Main_Alpha316_g51348 = ( _MainColor.a * tex2DNode29_g51348.a );
				float Mesh_Variation16_g51348 = packedInput.ase_color.r;
				float lerpResult4033_g51348 = lerp( 0.9 , (Mesh_Variation16_g51348*0.5 + 0.5) , _AlphaVariationValue);
				half Global_Extras_Alpha1033_g51348 = break89_g51514.a;
				float temp_output_4022_0_g51348 = ( lerpResult4033_g51348 - ( 1.0 - Global_Extras_Alpha1033_g51348 ) );
				half AlphaTreshold2132_g51348 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g51348 = ( temp_output_4022_0_g51348 + AlphaTreshold2132_g51348 );
				#else
				float staticSwitch4017_g51348 = temp_output_4022_0_g51348;
				#endif
				float lerpResult4011_g51348 = lerp( 1.0 , staticSwitch4017_g51348 , _GlobalAlpha);
				half Global_Alpha315_g51348 = saturate( lerpResult4011_g51348 );
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g51348 = ( ( Main_Alpha316_g51348 * Global_Alpha315_g51348 ) - ( AlphaTreshold2132_g51348 - 0.5 ) );
				#else
				float staticSwitch3792_g51348 = ( Main_Alpha316_g51348 * Global_Alpha315_g51348 );
				#endif
				half Final_Alpha3754_g51348 = staticSwitch3792_g51348;
				float temp_output_661_0_g51348 = ( saturate( ( temp_output_41_0_g51554 + ( temp_output_41_0_g51554 * SAMPLE_TEXTURE3D( TVE_ScreenTex3D, samplerTVE_ScreenTex3D, ( TVE_ScreenTexCoord * PositionWS_PerVertex3905_g51348 ) ).r ) ) ) * Final_Alpha3754_g51348 );
				float Alpha3735_g51348 = temp_output_661_0_g51348;
				float Treshold3735_g51348 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g51348 - Treshold3735_g51348);
				#endif
				}
				half Final_Clip914_g51348 = saturate( Alpha3735_g51348 );
				
				surfaceDescription.Albedo = ( Final_Albedo359_g51348 * Vertex_Occlusion648_g51348 );
				surfaceDescription.Normal = Final_Normal366_g51348;
				...
				surfaceDescription.Emission = Final_Emissive2476_g51348;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g51348;
				surfaceDescription.Occlusion = Blend_Occlusion323_g51348;
				surfaceDescription.Alpha = Final_Clip914_g51348;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half3 _Vector1 = half3(0,0,0);
				half3 Off19_g51539 = _Vector1;
				float3 appendResult2827_g51348 = (float3(inputMesh.uv0.z , inputMesh.ase_texcoord3.w , inputMesh.uv0.w));
				half3 Mesh_PivotsData2831_g51348 = ( appendResult2827_g51348 * _VertexPivotMode );
				half3 On20_g51539 = Mesh_PivotsData2831_g51348;
				#ifdef TVE_PIVOT_DATA_BAKED
				float3 staticSwitch14_g51539 = On20_g51539;
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g51531 = ObjectPosition_UNITY_MATRIX_M();
				half3 Off19_g51532 = localObjectPosition_UNITY_MATRIX_M14_g51531;
				float3 appendResult93_g51531 = (float3(inputMesh.uv0.z , inputMesh.ase_texcoord3.w , inputMesh.uv0.w));
				float3 temp_output_91_0_g51531 = ( appendResult93_g51531 * _vertex_pivot_mode );
				float3 PivotsOnly105_g51531 = (mul( GetObjectToWorldMatrix(), float4( temp_output_91_0_g51531 , 0.0 ) ).xyz).xyz;
				half3 On20_g51532 = ( localObjectPosition_UNITY_MATRIX_M14_g51531 + PivotsOnly105_g51531 );
				#ifdef TVE_PIVOT_DATA_BAKED
				...
				half3 Gradient_Tint2784_g51348 = (lerpResult2779_g51348).rgb;
				float3 vertexToFrag11_g51559 = Gradient_Tint2784_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord.xyz = vertexToFrag11_g51559;
				float3 temp_cast_24 = (_NoiseScaleValue).xxx;
				float3 vertexToFrag3890_g51348 = ase_worldPos;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
				float temp_output_7_0_g51560 = _NoiseMinValue;
				...
				half3 Noise_Tint2802_g51348 = (lerpResult2800_g51348).rgb;
				float3 vertexToFrag11_g51553 = Noise_Tint2802_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord1.xyz = vertexToFrag11_g51553;
				float lerpResult169_g51439 = lerp( 4.0 , 2.0 , temp_output_167_0_g51439);
				half Global_NoiseTex_H2869_g51348 = pow( abs( tex2DNode75_g51439.a ) , lerpResult169_g51439 );
				half3 Highlight_Tint3231_g51348 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g51348 * Wind_Power_103106_g51348 * inputMesh.ase_color.r ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g51547 = Highlight_Tint3231_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag11_g51547;
				...
				half Global_ColorsTex_A1701_g51348 = (lerpResult88_g51502).a;
				float vertexToFrag11_g51555 = Global_ColorsTex_A1701_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord.w = vertexToFrag11_g51555;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g51348;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.zw = vertexToFrag11_g51537;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 vertexToFrag11_g51559 = packedInput.ase_texcoord.xyz;
				float3 vertexToFrag11_g51553 = packedInput.ase_texcoord1.xyz;
				float3 vertexToFrag11_g51547 = packedInput.ase_texcoord2.xyz;
				...
				float dotResult3616_g51348 = dot( Blend_AlbedoTinted2808_g51348 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g51348).xxx;
				float vertexToFrag11_g51555 = packedInput.ase_texcoord.w;
				half Global_Colors_Influence3668_g51348 = vertexToFrag11_g51555;
				float3 lerpResult3618_g51348 = lerp( Blend_AlbedoTinted2808_g51348 , temp_cast_0 , Global_Colors_Influence3668_g51348);
				float3 vertexToFrag3890_g51348 = packedInput.ase_texcoord4.xyz;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
				float3 Position58_g51502 = PositionWS_PerVertex3905_g51348;
				float temp_output_82_0_g51502 = _LayerColorsValue;
				float4 lerpResult88_g51502 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g51502).xz ) ),temp_output_82_0_g51502 ) , TVE_ColorsUsage[(int)temp_output_82_0_g51502]);
				...
				float3 hdEmission4189_g51348 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g51537 = packedInput.ase_texcoord3.zw;
				half2 Emissive_UVs2468_g51348 = vertexToFrag11_g51537;
				half3 Final_Emissive2476_g51348 = ( (( hdEmission4189_g51348 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51348 ) )).rgb * TVE_EmissiveValue );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag3890_g51348 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord1.xyz = vertexToFrag3890_g51348;
				float2 vertexToFrag11_g51423 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					...
					)
			{
				...
				half Final_AlphaFade3727_g51348 = 1.0;
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g51348;
				float3 vertexToFrag3890_g51348 = packedInput.ase_texcoord1.xyz;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				half3 Gradient_Tint2784_g51348 = (lerpResult2779_g51348).rgb;
				float3 vertexToFrag11_g51559 = Gradient_Tint2784_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag11_g51559;
				float3 temp_cast_24 = (_NoiseScaleValue).xxx;
				float3 vertexToFrag3890_g51348 = ase_worldPos;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
				float temp_output_7_0_g51560 = _NoiseMinValue;
				...
				half3 Noise_Tint2802_g51348 = (lerpResult2800_g51348).rgb;
				float3 vertexToFrag11_g51553 = Noise_Tint2802_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag11_g51553;
				float lerpResult169_g51439 = lerp( 4.0 , 2.0 , temp_output_167_0_g51439);
				half Global_NoiseTex_H2869_g51348 = pow( abs( tex2DNode75_g51439.a ) , lerpResult169_g51439 );
				half3 Highlight_Tint3231_g51348 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g51348 * Wind_Power_103106_g51348 * inputMesh.ase_color.r ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g51547 = Highlight_Tint3231_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag11_g51547;
				float2 vertexToFrag11_g51423 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.xy = vertexToFrag11_g51423;
				float3 Position58_g51502 = PositionWS_PerVertex3905_g51348;
				float temp_output_82_0_g51502 = _LayerColorsValue;
				float4 lerpResult88_g51502 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g51502).xz ) ),temp_output_82_0_g51502, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g51502]);
				half Global_ColorsTex_A1701_g51348 = (lerpResult88_g51502).a;
				float vertexToFrag11_g51555 = Global_ColorsTex_A1701_g51348;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = vertexToFrag11_g51555;
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag3890_g51348;
				
				float2 vertexToFrag11_g51537 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.zw = vertexToFrag11_g51537;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 vertexToFrag11_g51559 = packedInput.ase_texcoord7.xyz;
				float3 vertexToFrag11_g51553 = packedInput.ase_texcoord8.xyz;
				float3 vertexToFrag11_g51547 = packedInput.ase_texcoord9.xyz;
				float2 vertexToFrag11_g51423 = packedInput.ase_texcoord10.xy;
				half2 Main_UVs15_g51348 = vertexToFrag11_g51423;
				float4 tex2DNode29_g51348 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51348 );
				float3 temp_output_51_0_g51348 = ( (_MainColor).rgb * (tex2DNode29_g51348).rgb );
				half3 Main_Albedo99_g51348 = temp_output_51_0_g51348;
				...
				float dotResult3616_g51348 = dot( Blend_AlbedoTinted2808_g51348 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g51348).xxx;
				float vertexToFrag11_g51555 = packedInput.ase_texcoord7.w;
				half Global_Colors_Influence3668_g51348 = vertexToFrag11_g51555;
				float3 lerpResult3618_g51348 = lerp( Blend_AlbedoTinted2808_g51348 , temp_cast_0 , Global_Colors_Influence3668_g51348);
				float3 vertexToFrag3890_g51348 = packedInput.ase_texcoord11.xyz;
				float3 PositionWS_PerVertex3905_g51348 = vertexToFrag3890_g51348;
				float3 Position58_g51502 = PositionWS_PerVertex3905_g51348;
				float temp_output_82_0_g51502 = _LayerColorsValue;
				float4 lerpResult88_g51502 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g51502).xz ) ),temp_output_82_0_g51502 ) , TVE_ColorsUsage[(int)temp_output_82_0_g51502]);
				...
				float3 hdEmission4189_g51348 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g51537 = packedInput.ase_texcoord10.zw;
				half2 Emissive_UVs2468_g51348 = vertexToFrag11_g51537;
				half3 Final_Emissive2476_g51348 = ( (( hdEmission4189_g51348 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51348 ) )).rgb * TVE_EmissiveValue );
...
Node;AmplifyShaderEditor.FunctionNode;605;-1536,-896;Inherit;False;Compile Core;-1;;51562;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;569;-2176,-384;Inherit;False;Base Shader;0;;51348;856f7164d1c579d43a5cf4968a75ca43;79,3880,1,3882,1,3957,1,4029,1,4028,1,3903,1,3904,1,3900,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,1271,1,3889,1,1708,1,3658,1,3509,1,1712,0,3873,1,1714,1,1715,1,1718,1,1717,1,916,0,1762,0,1763,0,3568,1,1949,1,1776,1,3475,1,893,1,1745,1,3479,0,3501,1,3221,1,1646,1,1690,1,1757,0,2807,1,3886,0,2953,1,3887,0,3243,1,3888,0,3728,0,3949,0,2172,0,3883,0,2658,1,1742,1,3484,0,3575,0,1733,0,1734,0,1736,0,1737,0,1735,0,1550,0,878,0,4070,0,4069,0,4067,0,4068,0,4072,0,860,1,3544,1,2261,1,2260,1,2032,0,2054,0,2060,0,2036,0,2062,1,2039,1,4177,1,3592,1,2750,1;0;19;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
...
Node;AmplifyShaderEditor.FunctionNode;535;-1888,384;Inherit;False;Define TVE IS GRASS SHADER;-1;;51347;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;534;-2176,384;Inherit;False;Define TVE PIVOT DATA BAKED;-1;;51346;8da5867b3f9f1834693af40d3eff73f4;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;211;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;604;-1344,-896;Inherit;False;Compile All Shaders;-1;;51345;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;603;-1600,384;Inherit;False;Define PIPELINE HD;-1;;51344;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=EC50199A91B8845FE0851246AA2BE3446C1197F2