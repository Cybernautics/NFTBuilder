	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 VertexPos40_g51512 = temp_output_2283_0_g50725;
				...
				float WorldData19_g51480 = Bounds_Radius121_g50725;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g51480 = WorldData19_g51480;
				#else
				float staticSwitch14_g51480 = ObjectData20_g51480;
				#endif
				float Motion_Max_Rolling1137_g50725 = staticSwitch14_g51480;
				...
				half4 Global_Motion_Params3909_g50725 = lerpResult87_g51481;
				float4 break322_g51421 = Global_Motion_Params3909_g50725;
				half Wind_Power369_g51421 = break322_g51421.z;
				float lerpResult410_g51421 = lerp( 0.2 , 1.0 , Wind_Power369_g51421);
				half Wind_Power_203109_g50725 = lerpResult410_g51421;
				...
				half Wind_Power2223_g50725 = Wind_Power369_g51421;
				float temp_output_167_0_g51439 = Wind_Power2223_g50725;
				...
				half Global_NoiseTex_R34_g50725 = break142_g51439.r;
				...
				#endif
				half Motion_Variation3073_g50725 = staticSwitch14_g51496;
				float temp_output_3154_0_g50725 = ( _MotionVariation_20 * Motion_Variation3073_g50725 );
				float Motion_Variation284_g51479 = temp_output_3154_0_g50725;
				float Motion_Scale287_g51479 = ( _MotionScale_20 * ase_worldPos.x );
				half Variation127_g51521 = temp_output_3154_0_g50725;
				...
				float temp_output_112_0_g51521 = Wind_Power2223_g50725;
				...
				half Motion_Rolling138_g50725 = ( ( _MotionAmplitude_20 * Motion_Max_Rolling1137_g50725 ) * ( Wind_Power_203109_g50725 * Mesh_Motion_260_g50725 * Global_NoiseTex_R34_g50725 * _VertexRollingMode ) * sin( ( mulTime354_g51479 + Motion_Variation284_g51479 + Motion_Scale287_g51479 ) ) * lerpResult126_g51521 );
				half Angle44_g51512 = Motion_Rolling138_g50725;
				...
				float WorldData19_g51438 = ( Bounds_Height374_g50725 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g51438 = WorldData19_g51438;
				#else
				float staticSwitch14_g51438 = ObjectData20_g51438;
				#endif
				float Motion_Max_Bending1133_g50725 = staticSwitch14_g51438;
				float lerpResult376_g51421 = lerp( 0.1 , 1.0 , Wind_Power369_g51421);
				half Wind_Power_103106_g50725 = lerpResult376_g51421;
				...
				half2 Wind_DirectionOS39_g50725 = (temp_output_339_0_g51421).xz;
				half Input_Speed62_g51477 = _MotionSpeed_10;
				float mulTime373_g51477 = _TimeParameters.x * Input_Speed62_g51477;
				half Motion_Variation284_g51477 = ( _MotionVariation_10 * Motion_Variation3073_g50725 );
				...
				half Input_Turbulence327_g51477 = Global_NoiseTex_R34_g50725;
				float2 lerpResult321_g51477 = lerp( Sine_MinusOneToOne281_g51477 , temp_cast_12 , Input_Turbulence327_g51477);
				half2 Motion_Bending2258_g50725 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g50725 ) * Wind_Power_103106_g50725 * Wind_DirectionOS39_g50725 * Global_NoiseTex_R34_g50725 * lerpResult321_g51477 );
				...
				half4 Global_React_Params4173_g50725 = lerpResult87_g51524;
				float4 break322_g51522 = Global_React_Params4173_g50725;
				half Interaction_Mask66_g50725 = break322_g51522.z;
				...
				half2 Interaction_DirectionOS4158_g50725 = (temp_output_339_0_g51522).xz;
				...
				half Angle44_g51437 = Motion_Z190_g50725;
				...
				half Angle44_g51436 = -Motion_X216_g50725;
				...
				float Motion_Variation330_g51550 = ( _MotionVariation_32 * Motion_Variation3073_g50725 );
				half Input_Amplitude58_g51550 = ( _MotionAmplitude_32 * Bounds_Radius121_g50725 * 0.1 );
				...
				#endif
				half Global_NoiseTex_A139_g50725 = break142_g51439.a;
				half Mesh_Motion_3144_g50725 = inputMesh.ase_texcoord3.z;
				float lerpResult378_g51421 = lerp( 0.3 , 1.0 , Wind_Power369_g51421);
				half Wind_Power_323115_g50725 = lerpResult378_g51421;
				float temp_output_7_0_g51448 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g50725 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g51448 ) / ( TVE_MotionFadeStart - temp_output_7_0_g51448 ) ) );
				half3 Motion_Detail263_g50725 = ( staticSwitch358_g51550 * ( ( Global_NoiseTex_R34_g50725 + Global_NoiseTex_A139_g50725 ) * Mesh_Motion_3144_g50725 * Wind_Power_323115_g50725 ) * Wind_FadeOut4005_g50725 );
				float3 Vertex_Motion_Object833_g50725 = ( ( VertexPosRotationAxis50_g51436 + ( VertexPosOtherAxis82_g51436 * cos( Angle44_g51436 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g51436 ) * sin( Angle44_g51436 ) ) ) + Motion_Detail263_g50725 );
				...
				#endif
				half Global_Vertex_Size174_g50725 = break322_g51522.w;
				...
				half3 ObjectData20_g51435 = appendResult3480_g50725;
				...
				#endif
				half3 Vertex_Size1741_g50725 = staticSwitch14_g51435;
				...
				float4 lerpResult2779_g50725 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g51549 ) / ( _GradientMaxValue - temp_output_7_0_g51549 ) ) ));
				half3 Gradient_Tint2784_g50725 = (lerpResult2779_g50725).rgb;
				float3 vertexToFrag11_g51559 = Gradient_Tint2784_g50725;
				...
				half Noise_Mask3162_g50725 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_20 * PositionWS_PerVertex3905_g50725 * 0.1 ), 0.0 ).r - temp_output_7_0_g51560 ) / ( _NoiseMaxValue - temp_output_7_0_g51560 ) ) );
				...
				float3 vertexToFrag11_g51553 = Noise_Tint2802_g50725;
				...
				float3 Position58_g51502 = PositionWS_PerVertex3905_g50725;
				...
				half Global_ColorsTex_A1701_g50725 = (lerpResult88_g51502).a;
				float vertexToFrag11_g51555 = Global_ColorsTex_A1701_g50725;
				...
				float saferPower3976_g50725 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g51545 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g51545 ) ) ) , 0.0001 );
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g51542 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord6.w = vertexToFrag11_g51542;
						...
						)
			{
				...
				half2 Main_UVs15_g50725 = vertexToFrag11_g51423;
				...
				half3 Blend_AlbedoTinted2808_g50725 = ( vertexToFrag11_g51559 * vertexToFrag11_g51553 * float3(1,1,1) * Blend_Albedo265_g50725 );
				...
				half Global_Colors_Influence3668_g50725 = vertexToFrag11_g51555;
				...
				half3 Global_ColorsTex_RGB1700_g50725 = (lerpResult88_g51502).rgb;
				...
				half Global_Colors_Mask3692_g50725 = saturate( ( ( Main_Mask57_g50725 - temp_output_7_0_g51543 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g51543 ) ) );
				...
				half Subsurface_Mask1557_g50725 = saturate( ( ( Main_Mask57_g50725 - temp_output_7_0_g51556 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g51556 ) ) );
				...
				#else
				float staticSwitch1604_g50725 = (-dotResult777_g50725*0.5 + 0.5);
				#endif
				half Mask_Subsurface_Normal870_g50725 = staticSwitch1604_g50725;
				half3 Subsurface_Deferred1693_g50725 = ( Subsurface_Transmission884_g50725 * ( ( Mask_Subsurface_View782_g50725 * Blend_AlbedoColored863_g50725 ) + Mask_Subsurface_Normal870_g50725 ) );
				half3 Blend_AlbedoAndSubsurface149_g50725 = ( Blend_AlbedoColored863_g50725 + Subsurface_Deferred1693_g50725 );
				...
				float3 Position82_g51514 = PositionWS_PerVertex3905_g50725;
				...
				half Global_Extras_Overlay156_g50725 = break89_g51514.b;
				...
				half Overlay_Mask269_g50725 = saturate( ( ( ( ( ( lerpResult3567_g50725 * 0.5 ) + Main_AlbedoTex_G3526_g50725 ) * Overlay_Commons1365_g50725 ) - temp_output_7_0_g51561 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g51561 ) ) );
				...
				float3 lerpResult2945_g50725 = lerp( (_VertexOcclusionColor).rgb , temp_cast_7 , saturate( ( ( Mesh_Occlusion318_g50725 - temp_output_7_0_g51557 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g51557 ) ) ));
				float3 Vertex_Occlusion648_g50725 = lerpResult2945_g50725;
				
				float3 temp_output_13_0_g51558 = Main_Normal137_g50725;
				float3 switchResult12_g51558 = (((isFrontFace>0)?(temp_output_13_0_g51558):(( temp_output_13_0_g51558 * _render_normals_options ))));
				half3 Blend_Normal312_g50725 = switchResult12_g51558;
				...
				half2 Emissive_UVs2468_g50725 = vertexToFrag11_g51537;
				half3 Final_Emissive2476_g50725 = ( (( hdEmission4189_g50725 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g50725 ) )).rgb * TVE_EmissiveValue );
				...
				half Global_Extras_Wetness305_g50725 = break89_g51514.g;
				...
				float vertexToFrag11_g51542 = packedInput.ase_texcoord6.w;
				half Fade_Camera3743_g50725 = vertexToFrag11_g51542;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
				float Mesh_Variation16_g50725 = packedInput.ase_color.r;
				float lerpResult4033_g50725 = lerp( 0.9 , (Mesh_Variation16_g50725*0.5 + 0.5) , _AlphaVariationValue);
				half Global_Extras_Alpha1033_g50725 = break89_g51514.a;
				float temp_output_4022_0_g50725 = ( lerpResult4033_g50725 - ( 1.0 - Global_Extras_Alpha1033_g50725 ) );
				...
				float temp_output_661_0_g50725 = ( saturate( ( temp_output_41_0_g51554 + ( temp_output_41_0_g51554 * SAMPLE_TEXTURE3D( TVE_ScreenTex3D, samplerTVE_ScreenTex3D, ( TVE_ScreenTexCoord * PositionWS_PerVertex3905_g50725 ) ).r ) ) ) * Final_Alpha3754_g50725 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g51542 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord1.w = vertexToFrag11_g51542;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g51542 = packedInput.ase_texcoord1.w;
				half Fade_Camera3743_g50725 = vertexToFrag11_g51542;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g51542 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord3.z = vertexToFrag11_g51542;
					...
					)
			{
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g51542 = packedInput.ase_texcoord3.z;
				half Fade_Camera3743_g50725 = vertexToFrag11_g51542;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g51542 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord8.w = vertexToFrag11_g51542;
						...
						)
			{
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g51542 = packedInput.ase_texcoord8.w;
				half Fade_Camera3743_g50725 = vertexToFrag11_g51542;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g51554 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-2176,-896;Half;False;Property;_IsLeafShader;_IsLeafShader;210;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;661;-1536,-896;Inherit;False;Compile Core;-1;;51563;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A6DFACC2882FCF3E4E716D4746200174F59491E6