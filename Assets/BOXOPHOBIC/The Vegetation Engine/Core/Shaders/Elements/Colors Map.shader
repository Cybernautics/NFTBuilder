	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 break469_g19058 = saturate( ( ( tex2DNode17_g19058 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19310 ) ) );
				...
				half2 temp_output_851_0_g19058 = saturate( ( ( abs( (( (temp_output_35_0_g19312).zw + ( (temp_output_35_0_g19312).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19313 ) ) );
				half2 break852_g19058 = ( temp_output_851_0_g19058 * temp_output_851_0_g19058 );
				half Enable_Fade_Support454_g19058 = _ElementFadeSupport;
				half lerpResult842_g19058 = lerp( 1.0 , ( 1.0 - saturate( ( break852_g19058.x + break852_g19058.y ) ) ) , Enable_Fade_Support454_g19058);
				half FadeOut_Mask656_g19058 = lerpResult842_g19058;
...
/*ASEBEGIN
Version=18909
1920;0;1920;1029;1387.167;1068.816;1;True;False
...
ASEEND*/
//CHKSM=BBB6602BA349A2C0BCB8BF8B889F6A1C0923C78B