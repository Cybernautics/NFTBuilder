	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 lerpResult1545_g51344 = lerp( inputMesh.ase_texcoord.xy , inputMesh.uv1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g51344 = lerpResult1545_g51344;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float2 staticSwitch3466_g51344 = (ase_worldPos).xz;
				#else
				float2 staticSwitch3466_g51344 = lerpResult1545_g51344;
				#endif
				float2 vertexToFrag11_g51446 = ( ( staticSwitch3466_g51344 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = vertexToFrag11_g51446;
				half Mesh_DetailMask90_g51344 = inputMesh.ase_color.b;
				float vertexToFrag11_g51546 = ( ( Mesh_DetailMask90_g51344 - 0.5 ) + _DetailMeshValue );
				...
				float3 vertexToFrag3890_g51344 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3890_g51344;
						...
						)
			{
				...
				half2 Main_UVs15_g51344 = vertexToFrag11_g51423;
				float4 tex2DNode29_g51344 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51344 );
				float3 temp_output_51_0_g51344 = ( (_MainColor).rgb * (tex2DNode29_g51344).rgb );
				half3 Main_Albedo99_g51344 = temp_output_51_0_g51344;
				float2 vertexToFrag11_g51446 = packedInput.ase_texcoord5.zw;
				half2 Second_UVs17_g51344 = vertexToFrag11_g51446;
				half3 Second_Albedo153_g51344 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g51344 ) )).rgb;
				float vertexToFrag11_g51546 = packedInput.ase_texcoord6.x;
				float temp_output_3919_0_g51344 = vertexToFrag11_g51546;
				float3 unpack4112_g51344 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g51344 ), _MainNormalValue );
				unpack4112_g51344.z = lerp( 1, unpack4112_g51344.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51344 = unpack4112_g51344;
				...
				float3 tanNormal4099_g51344 = Main_Normal137_g51344;
				float3 worldNormal4099_g51344 = float3(dot(tanToWorld0,tanNormal4099_g51344), dot(tanToWorld1,tanNormal4099_g51344), dot(tanToWorld2,tanNormal4099_g51344));
				float3 Main_Normal_WS4101_g51344 = worldNormal4099_g51344;
				float lerpResult1537_g51344 = lerp( Main_Normal_WS4101_g51344.y , -Main_Normal_WS4101_g51344.y , _DetailProjectionMode);
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float staticSwitch3467_g51344 = temp_output_3919_0_g51344;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float staticSwitch3467_g51344 = ( ( lerpResult1537_g51344 * 0.5 ) + _DetailMeshValue );
				#else
				float staticSwitch3467_g51344 = temp_output_3919_0_g51344;
				#endif
				half Blend_Source1540_g51344 = staticSwitch3467_g51344;
				float4 tex2DNode35_g51344 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g51344 );
				half Main_Mask57_g51344 = tex2DNode35_g51344.b;
				float4 tex2DNode33_g51344 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_SecondMaskTex, Second_UVs17_g51344 );
				half Second_Mask81_g51344 = tex2DNode33_g51344.b;
				float lerpResult1327_g51344 = lerp( Main_Mask57_g51344 , Second_Mask81_g51344 , _DetailMaskMode);
				float lerpResult4058_g51344 = lerp( lerpResult1327_g51344 , ( 1.0 - lerpResult1327_g51344 ) , _DetailMaskInvertMode);
				float temp_output_7_0_g51551 = _DetailBlendMinValue;
				half Mask_Detail147_g51344 = saturate( ( ( saturate( ( Blend_Source1540_g51344 + ( Blend_Source1540_g51344 * lerpResult4058_g51344 ) ) ) - temp_output_7_0_g51551 ) / ( _DetailBlendMaxValue - temp_output_7_0_g51551 ) ) );
				float3 lerpResult235_g51344 = lerp( Main_Albedo99_g51344 , ( Main_Albedo99_g51344 * Second_Albedo153_g51344 * 4.594794 ) , Mask_Detail147_g51344);
				float3 lerpResult208_g51344 = lerp( Main_Albedo99_g51344 , Second_Albedo153_g51344 , Mask_Detail147_g51344);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g51344 = lerpResult235_g51344;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g51344 = lerpResult208_g51344;
				#else
				float3 staticSwitch4062_g51344 = lerpResult235_g51344;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g51344 = Main_Albedo99_g51344;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g51344 = staticSwitch4062_g51344;
				#else
				float3 staticSwitch255_g51344 = Main_Albedo99_g51344;
				#endif
				half3 Blend_Albedo265_g51344 = staticSwitch255_g51344;
				half3 Blend_AlbedoTinted2808_g51344 = ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) * Blend_Albedo265_g51344 );
				half3 Blend_AlbedoColored863_g51344 = Blend_AlbedoTinted2808_g51344;
				half3 Blend_AlbedoAndSubsurface149_g51344 = Blend_AlbedoColored863_g51344;
				half3 Global_OverlayColor1758_g51344 = (TVE_OverlayColor).rgb;
				float lerpResult3567_g51344 = lerp( _OverlayBottomValue , 1.0 , Main_Normal_WS4101_g51344.y);
				half Main_AlbedoTex_G3526_g51344 = tex2DNode29_g51344.g;
				half Second_AlbedoTex_G3581_g51344 = (SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g51344 )).g;
				float lerpResult3579_g51344 = lerp( Main_AlbedoTex_G3526_g51344 , Second_AlbedoTex_G3581_g51344 , Mask_Detail147_g51344);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch3574_g51344 = Main_AlbedoTex_G3526_g51344;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch3574_g51344 = lerpResult3579_g51344;
				#else
				float staticSwitch3574_g51344 = Main_AlbedoTex_G3526_g51344;
				#endif
				float3 vertexToFrag3890_g51344 = packedInput.ase_texcoord7.xyz;
				float3 PositionWS_PerVertex3905_g51344 = vertexToFrag3890_g51344;
				float3 Position82_g51514 = PositionWS_PerVertex3905_g51344;
				...
				half Global_Extras_Overlay156_g51344 = break89_g51514.b;
				float temp_output_1025_0_g51344 = ( _GlobalOverlay * Global_Extras_Overlay156_g51344 );
				half Overlay_Commons1365_g51344 = temp_output_1025_0_g51344;
				float temp_output_7_0_g51561 = _OverlayMaskMinValue;
				half Overlay_Mask269_g51344 = saturate( ( ( ( ( ( lerpResult3567_g51344 * 0.5 ) + staticSwitch3574_g51344 ) * Overlay_Commons1365_g51344 ) - temp_output_7_0_g51561 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g51561 ) ) );
				float3 lerpResult336_g51344 = lerp( Blend_AlbedoAndSubsurface149_g51344 , Global_OverlayColor1758_g51344 , Overlay_Mask269_g51344);
				half3 Final_Albedo359_g51344 = lerpResult336_g51344;
				
				float3 unpack4114_g51344 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_SecondMaskTex, Second_UVs17_g51344 ), _SecondNormalValue );
				unpack4114_g51344.z = lerp( 1, unpack4114_g51344.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g51344 = unpack4114_g51344;
				float3 lerpResult230_g51344 = lerp( float3( 0,0,1 ) , Second_Normal179_g51344 , Mask_Detail147_g51344);
				float3 lerpResult3372_g51344 = lerp( float3( 0,0,1 ) , Main_Normal137_g51344 , _DetailNormalValue);
				float3 lerpResult3376_g51344 = lerp( Main_Normal137_g51344 , BlendNormal( lerpResult3372_g51344 , Second_Normal179_g51344 ) , Mask_Detail147_g51344);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g51344 = BlendNormal( Main_Normal137_g51344 , lerpResult230_g51344 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g51344 = lerpResult3376_g51344;
				#else
				float3 staticSwitch4063_g51344 = BlendNormal( Main_Normal137_g51344 , lerpResult230_g51344 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch267_g51344 = Main_Normal137_g51344;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g51344 = staticSwitch4063_g51344;
				#else
				float3 staticSwitch267_g51344 = Main_Normal137_g51344;
				#endif
				float3 temp_output_13_0_g51558 = staticSwitch267_g51344;
				float3 switchResult12_g51558 = (((isFrontFace>0)?(temp_output_13_0_g51558):(( temp_output_13_0_g51558 * _render_normals_options ))));
				half3 Blend_Normal312_g51344 = switchResult12_g51558;
				half3 Final_Normal366_g51344 = Blend_Normal312_g51344;
				
				half Main_Metallic237_g51344 = ( tex2DNode35_g51344.r * _MainMetallicValue );
				half Second_Metallic226_g51344 = ( tex2DNode33_g51344.r * _SecondMetallicValue );
				float lerpResult278_g51344 = lerp( Main_Metallic237_g51344 , Second_Metallic226_g51344 , Mask_Detail147_g51344);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4064_g51344 = Main_Metallic237_g51344;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4064_g51344 = lerpResult278_g51344;
				#else
				float staticSwitch4064_g51344 = Main_Metallic237_g51344;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch299_g51344 = Main_Metallic237_g51344;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g51344 = staticSwitch4064_g51344;
				#else
				float staticSwitch299_g51344 = Main_Metallic237_g51344;
				#endif
				half Blend_Metallic306_g51344 = staticSwitch299_g51344;
				float lerpResult342_g51344 = lerp( Blend_Metallic306_g51344 , 0.0 , Overlay_Mask269_g51344);
				half Final_Metallic367_g51344 = lerpResult342_g51344;
				
				float3 hdEmission4189_g51344 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g51537 = packedInput.ase_texcoord8.xy;
				half2 Emissive_UVs2468_g51344 = vertexToFrag11_g51537;
				half3 Final_Emissive2476_g51344 = ( (( hdEmission4189_g51344 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51344 ) )).rgb * TVE_EmissiveValue );
				
				half Main_Smoothness227_g51344 = ( tex2DNode35_g51344.a * _MainSmoothnessValue );
				half Second_Smoothness236_g51344 = ( tex2DNode33_g51344.a * _SecondSmoothnessValue );
				float lerpResult266_g51344 = lerp( Main_Smoothness227_g51344 , Second_Smoothness236_g51344 , Mask_Detail147_g51344);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g51344 = Main_Smoothness227_g51344;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g51344 = lerpResult266_g51344;
				#else
				float staticSwitch4065_g51344 = Main_Smoothness227_g51344;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch297_g51344 = Main_Smoothness227_g51344;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g51344 = staticSwitch4065_g51344;
				#else
				float staticSwitch297_g51344 = Main_Smoothness227_g51344;
				#endif
				half Blend_Smoothness314_g51344 = staticSwitch297_g51344;
				half Global_OverlaySmoothness311_g51344 = TVE_OverlaySmoothness;
				float lerpResult343_g51344 = lerp( Blend_Smoothness314_g51344 , Global_OverlaySmoothness311_g51344 , Overlay_Mask269_g51344);
				half Final_Smoothness371_g51344 = lerpResult343_g51344;
				half Global_Extras_Wetness305_g51344 = break89_g51514.g;
				float lerpResult3673_g51344 = lerp( 0.0 , Global_Extras_Wetness305_g51344 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g51344 = saturate( ( Final_Smoothness371_g51344 + lerpResult3673_g51344 ) );
				
				float lerpResult240_g51344 = lerp( 1.0 , tex2DNode35_g51344.g , _MainOcclusionValue);
				half Main_Occlusion247_g51344 = lerpResult240_g51344;
				float lerpResult239_g51344 = lerp( 1.0 , tex2DNode33_g51344.g , _SecondOcclusionValue);
				half Second_Occlusion251_g51344 = lerpResult239_g51344;
				float lerpResult294_g51344 = lerp( Main_Occlusion247_g51344 , Second_Occlusion251_g51344 , Mask_Detail147_g51344);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g51344 = Main_Occlusion247_g51344;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g51344 = lerpResult294_g51344;
				#else
				float staticSwitch4066_g51344 = Main_Occlusion247_g51344;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch310_g51344 = Main_Occlusion247_g51344;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g51344 = staticSwitch4066_g51344;
				#else
				float staticSwitch310_g51344 = Main_Occlusion247_g51344;
				#endif
				half Blend_Occlusion323_g51344 = staticSwitch310_g51344;
				
				float localCustomAlphaClip3735_g51344 = ( 0.0 );
				half Final_AlphaFade3727_g51344 = 1.0;
				float Main_Alpha316_g51344 = ( _MainColor.a * tex2DNode29_g51344.a );
				half AlphaTreshold2132_g51344 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g51344 = ( Main_Alpha316_g51344 - ( AlphaTreshold2132_g51344 - 0.5 ) );
				#else
				float staticSwitch3792_g51344 = Main_Alpha316_g51344;
				#endif
				half Final_Alpha3754_g51344 = staticSwitch3792_g51344;
				float temp_output_661_0_g51344 = ( Final_AlphaFade3727_g51344 * Final_Alpha3754_g51344 );
				float Alpha3735_g51344 = temp_output_661_0_g51344;
				float Treshold3735_g51344 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g51344 - Treshold3735_g51344);
				#endif
				}
				half Final_Clip914_g51344 = saturate( Alpha3735_g51344 );
				
				surfaceDescription.Albedo = Final_Albedo359_g51344;
				surfaceDescription.Normal = Final_Normal366_g51344;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Final_Metallic367_g51344;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Final_Emissive2476_g51344;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g51344;
				surfaceDescription.Occlusion = Blend_Occlusion323_g51344;
				surfaceDescription.Alpha = Final_Clip914_g51344;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 lerpResult1545_g51344 = lerp( inputMesh.uv0.xy , inputMesh.uv1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g51344 = lerpResult1545_g51344;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				float3 vertexToFrag3890_g51344 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g51344;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float staticSwitch3574_g51344 = Main_AlbedoTex_G3526_g51344;
				#endif
				float3 vertexToFrag3890_g51344 = packedInput.ase_texcoord4.xyz;
				float3 PositionWS_PerVertex3905_g51344 = vertexToFrag3890_g51344;
				float3 Position82_g51514 = PositionWS_PerVertex3905_g51344;
				float temp_output_84_0_g51514 = _LayerExtrasValue;
				float4 lerpResult88_g51514 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g51514).xz ) ),temp_output_84_0_g51514 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g51514]);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag11_g51423 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord1.xy = vertexToFrag11_g51423;
					...
					)
			{
				...
				float localCustomAlphaClip3735_g51344 = ( 0.0 );
				half Final_AlphaFade3727_g51344 = 1.0;
				float2 vertexToFrag11_g51423 = packedInput.ase_texcoord1.xy;
				half2 Main_UVs15_g51344 = vertexToFrag11_g51423;
				float4 tex2DNode29_g51344 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51344 );
				float Main_Alpha316_g51344 = ( _MainColor.a * tex2DNode29_g51344.a );
				half AlphaTreshold2132_g51344 = _Cutoff;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 lerpResult1545_g51344 = lerp( inputMesh.ase_texcoord.xy , inputMesh.ase_texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g51344 = lerpResult1545_g51344;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				float3 vertexToFrag3890_g51344 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3890_g51344;
					...
					)
			{
				...
				float staticSwitch3574_g51344 = Main_AlbedoTex_G3526_g51344;
				#endif
				float3 vertexToFrag3890_g51344 = packedInput.ase_texcoord5.xyz;
				float3 PositionWS_PerVertex3905_g51344 = vertexToFrag3890_g51344;
				float3 Position82_g51514 = PositionWS_PerVertex3905_g51344;
				float temp_output_84_0_g51514 = _LayerExtrasValue;
				float4 lerpResult88_g51514 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g51514).xz ) ),temp_output_84_0_g51514 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g51514]);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag3890_g51344 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g51344;
						...
						)
			{
				...
				float staticSwitch3574_g51344 = Main_AlbedoTex_G3526_g51344;
				#endif
				float3 vertexToFrag3890_g51344 = packedInput.ase_texcoord9.xyz;
				float3 PositionWS_PerVertex3905_g51344 = vertexToFrag3890_g51344;
				float3 Position82_g51514 = PositionWS_PerVertex3905_g51344;
				float temp_output_84_0_g51514 = _LayerExtrasValue;
				float4 lerpResult88_g51514 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g51514).xz ) ),temp_output_84_0_g51514 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g51514]);
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2610.445;824.538;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-2176,-896;Half;False;Property;_IsPropShader;_IsPropShader;210;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;134;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;211;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;382;-2176,-384;Inherit;False;Base Shader;0;;51344;856f7164d1c579d43a5cf4968a75ca43;79,3880,1,3882,1,3957,0,4029,1,4028,1,3903,1,3904,1,3900,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,1271,0,3889,1,1708,0,3658,0,3509,1,1712,0,3873,1,1714,1,1715,1,1718,1,1717,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,0,3475,1,893,0,1745,0,3479,0,3501,0,3221,2,1646,0,1690,0,1757,0,2807,0,3886,0,2953,0,3887,0,3243,0,3888,0,3728,0,3949,0,2172,0,3883,0,2658,0,1742,0,3484,0,3575,1,1733,1,1734,1,1736,1,1737,1,1735,1,1550,1,878,1,4070,0,4069,0,4067,0,4068,0,4072,0,860,0,3544,1,2261,1,2260,1,2032,1,2054,1,2060,1,2036,1,2062,1,2039,1,4177,1,3592,1,2750,0;0;19;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
Node;AmplifyShaderEditor.FunctionNode;341;-2176,384;Inherit;False;Define TVE VERTEX DATA BATCHED;-1;;51562;749c61e1189c7f8408d9e6db94560d1d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;405;-1568,384;Inherit;False;Define PIPELINE HD;-1;;51342;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;407;-1536,-896;Inherit;False;Compile Core;-1;;51341;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;406;-1344,-896;Inherit;False;Compile All Shaders;-1;;51340;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;343;-1856,384;Inherit;False;Define TVE IS OBJECT SHADER;-1;;51343;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A0A3B1DB2788BE4C44E031CA6EF722F23A5AC33C